...
from Commons.consts import UNKNOWN_STRAND, MismatchesAndRefsEnum
...
def parse_count_pileup(count_pileup_file, snps={}):
    ...
    with open(count_pileup_file) as count_pileup_fh:
        for line in count_pileup_fh:
            chrom, start, end, position, ref_pos, total_coverage, adenosines, cytosines, guanosines, thymines, unrecognized, low_q = line.strip(
                "\n").split(TABLE_SEP)
